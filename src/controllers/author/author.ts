...
export const qGetDraftedBlogs = compose(ErrorHandling, authMiddleware, checkRole(['Author']))(async (_: any, __: any, context: MyContext): Promise<BlogResponse> => {
...
export const qGetMyFollowers = compose(ErrorHandling, authMiddleware, checkRole(['Author']))(async (_: any, __: any, context: MyContext): Promise<FollowUserResponse> => {
